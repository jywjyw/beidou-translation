...
public class Img4bitUtil {
	...
	public static BufferedImage jointTiles(List<BufferedImage> tiles, int column) throws IOException{
		return jointTiles(tiles, column, 0,0, null);
	}
	 ...
	 * @return
	 */
	public static BufferedImage jointTiles(List<BufferedImage> tiles, int column, int marginRight, int marginBottom, int[] bgColor) {
		...
		BufferedImage joint = new BufferedImage(tileW*column+marginRight, jointH+marginBottom, firstImg.getType());
